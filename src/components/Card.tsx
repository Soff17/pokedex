...
export default function Card({
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-yellow-400 to-red-500">
      ...
      <div className={`bg-[url('/Users/julietteceballos/Desktop/1/src/assets/grises.jpg')] p-7 rounded-3xl shadow-2xl w-1/3 m-5 border-2 border-black transition duration-500 hover:scale-105`}>
      <div
